...
def expected_tile(action, vis, gap=0.0):
    ...
    table = {
        ...
        "topLeft": (x, y, hw, hh),
        "topRight": (x + hw, y, hw, hh),
        "bottomLeft": (x, y + hh, hw, hh),
        "bottomRight": (x + hw, y + hh, hw, hh),
        "leftThird": (x, y, tw, h),
...
def expected_cocoa(action, vis, current, gap=0.0):
    ...
    table = {
        ...
        "bottomHalf": (x, y, w, hh),
        "topLeft": (x, y + hh, hw, h - hh),
        "topRight": (x + hw, y + hh, w - hw, h - hh),
        "bottomLeft": (x, y, hw, hh),
        "bottomRight": (x + hw, y, w - hw, hh),
        "leftThird": (x, y, tw, h),
        "centerThird": (x + tw, y, tw, h),
